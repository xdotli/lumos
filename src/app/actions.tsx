    ...
    messages: [
      {
        role: "system",
        content:
          "You are a helpful assistant that extracts stock tickers from text.",
      },
      {
        role: "user",
        content: `Extract all stock tickers from the following text. Return only a comma-separated list of tickers, nothing else: ${input}`,
      },
    ],
  });
      ...
      messages: [
        {
          role: "system",
          content:
            "You are a helpful assistant that extracts event information from HTML.",
        },
        {
          role: "user",
          content: `
...
${html}
    ...
    if (
      ...
      return {
        ...
        irPageUrl: await getCompanyIRPage(ticker),
      };
    }
    return {
      ticker,
